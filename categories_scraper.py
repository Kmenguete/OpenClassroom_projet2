...
# The get_all_categories function return book information and their corresponding image file for every category. However,
# this function return only the first page of every category. In the get_all_categories function, we called
